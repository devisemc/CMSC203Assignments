...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
	  for (int i = 0; i < intArray.length; i++)//for each row
		  for (int j = 0; j < intArray[i].length; j++)//for each column in that row
		  {
			  System.out.print(intArray[i][j] + " ");//print value at that row and animate
			  animate(i, j);
		  }
  }
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
		for (int j = 0; j < intArray[row].length; j++)//for each column in specified row
		{
			intArray[row][j] = value;//set value to new value and animate
			animate(row, j);
		}
   }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	  ...
	  for (int i = 0; i < intArray.length; i++)//for each row
	  {
		  if (intArray[i][column] < min)//check if value at specified column in that row is less than previous minimum
   ...
   public int countFound( int value )
   {
    ...
    // Write your code here:
	 ...
	 for (int i = 0; i < intArray.length; i++)//for each row
		  for (int j = 0; j < intArray[i].length; j++)//for each column in that row
		  {
			  if (intArray[i][j] == value)//check if that value is equal to passed in value
